...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ URL::action('PrescriptionController@storeAdmin') }}" method="POST" class="needs-validation"
            novalidate>
            {{ csrf_field() }}
            ...
            <a href="{{ URL::action('PrescriptionController@indexAdmin') }}" class="btn btn-secondary">Indietro</a>
