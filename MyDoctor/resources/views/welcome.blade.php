  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 img-box d-flex justify-content-center align-items-stretch position-relative"></div>
    ...
    <section id="dottori" class="dottori">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Dottori</h2>
          <p>Un Team altamente specializzato in continuo aumento</p>
        </div>
