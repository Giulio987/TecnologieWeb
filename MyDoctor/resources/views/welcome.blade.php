...
@section('content')  
  ...
  <section id="benvenuto" class="d-flex align-items-center">
    <div class="container">
      ...
      <h2> Al giorno d’oggi per poter richiedere un appuntamento al medico è necessario telefonare e prenotare o andare nello studio e attendere la coda.
           Con MyDoctor non sarà più necessario.
      </h2>
      <a href="#about" class="btn-get-started scrollto">INIZIAMO</a>
    </div>
  </section>
  <!-- End  -->
