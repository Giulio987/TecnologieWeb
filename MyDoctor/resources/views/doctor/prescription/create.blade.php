...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ URL::action('PrescriptionController@storePrescription') }}" method="POST" class="needs-validation"
            novalidate>
            {{ csrf_field() }}
            ...
            <a href="{{ URL::action('PrescriptionController@indexPrescription') }}" class="btn btn-secondary">Indietro</a>
